...
const reducer = (state: CartStateType, action: ReducerAction): CartStateType => {
    switch (action.type) {
        case REDUCER_ACTION_TYPE.ADD: {
            ...
            return { ... state, cart: [ ... filteredCart, { sku, name, price,
            qty }] };
...
export type UseProductsContextType = ReturnType<typeof useCartContext>
...
export const createContext = createContext<useCartContextType>
